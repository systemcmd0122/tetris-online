...
export const UPDATE_LOG = [
  {
    version: "4.0.0",
    title: "ボードの大型化 & システムリファクタリング",
    changes: [
      "【UI改善】テトリスのプレイ画面（ボード）を従来の1.5倍に大型化しました。視認性が大幅に向上し、より快適にプレイできるようになりました。",
      "【UI改善】大画面化に伴い、スマートフォンやタブレットなどの画面サイズに合わせて自動で最適な大きさに調整されるレスポンス・スケーリング機能を強化しました。",
      "【リファクタリング】肥大化していたプログラムファイルを「ゲームエンジン」「AIロジック」「各モード専用ロジック」に分割しました。これにより、動作の安定性と今後の機能追加のしやすさが向上しました。",
      "【最適化】マルチプレイ・ボット対戦・スプリントの各モードで、共通の最新ゲームエンジンを使用するように統一し、挙動の不整合を解消しました。"
    ]
  },
  {
    version: "3.9.0",
